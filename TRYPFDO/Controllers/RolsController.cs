...
namespace TRYPFDO.Controllers
{
    public class RolsController : Controller
    {
        private readonly TRYPFDOContext _context;

        public RolsController(TRYPFDOContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TRYPFDOContext.Roles'  is null.");
            }
            var rol = await _context.Roles.FindAsync(id);
            if (rol != null)
            {
